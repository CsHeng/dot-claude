...
REQUIRED: Flag capability-level or mode placed outside frontmatter as violations  
...
REQUIRED: Express capability-related metadata only through frontmatter fields so tools can derive levels and modes
